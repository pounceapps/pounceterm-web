...
window.PT_SCENES = {
  ...
  fleet: {
    title: 'PounceTERM — agents group (tiled 1×3)',
    tabs: ['agents'],
    tiled: ['api', 'frontend', 'infra'],
    steps: [
      { type: 'pout', pane: 'api', lines: [['grn', '✳ refactoring handlers…'], ['dim', 'claude · work-enterprise']], ms: 600 },
      { type: 'pout', pane: 'frontend', lines: [['grn', '✳ writing tests…'], ['dim', 'claude · work-enterprise']], ms: 600 },
      { type: 'pout', pane: 'infra', lines: [['grn', '✳ terraform plan…'], ['dim', 'claude · work-enterprise']], ms: 900 },
      { type: 'pout', pane: 'infra', lines: [['amb', '⚠ needs you:'], ['amb', 'approve plan'], ['amb', '[Allow] [Deny]']], ms: 700 },
      { type: 'badge', text: 'agents · 1 needs you', on: true },
      { type: 'pout', pane: 'api', lines: [['', 'still working —'], ['', 'a banner pinged you'], ['', 'for infra only.']], ms: 500 },
      { type: 'pout', pane: 'frontend', lines: [['grn', 'ok 34 tests']], ms: 400 },
    ],
  },
  files: {
